...
class Navbar extends Component {
  ...
  render() {
    ...
    return (
      <>
        <div id="navbar" className="navbar-area p-0 fixed-top">
            ...
            <div className="container">
              ...
              <div className={classOne} id="navbarSupportedContent">
                ...
                <div className="others-options">
                  <Link href="https://api.whatsapp.com/send/?phone=919811124255&text=Kindly%20Provide%20Me%20Quotation%20as%20Per%20These%20Details%20Comments%20:%20Information">
                    <a>
                      <img
                ...
                <span>
                  <span style={{color:"#BBD75B",marginLeft:"6px"}}>Click to Chat <br/>

                </span>
                <strong style={{color:"#BBD75B"}}>+91 9811124255</strong>
                  </span>
              </div>
            </div>
          </nav>
